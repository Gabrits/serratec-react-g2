                ...
                <div className="publicacao">
                  <div className="nomefoto">
                    <div className="fotoPerfil">
                      <img
                        src="https://i.pinimg.com/474x/fa/ba/54/faba5498b3167071dc93e22f3ce1e22a.jpg"
                        alt=""
                        width={50}
                        height={50}
                      />
              ...
              <img src="src/assets/comentarioBranco.png" width={30} height={39} />
                    ...
                    <div className="editar">
                      <Link to={`/feedMore/${publicacao.id}`}>
                        <img
                          src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/White_pencil_icon.svg/800px-White_pencil_icon.svg.png"
                          width={20}
                          height={40}
                        />
                      </Link>
